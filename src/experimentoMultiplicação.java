public class experimentoMultiplicação {
    ...
    public static void experimento(){
        ...
        for (int tamanho : tamanhos) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                MListaEncadeada restultante = matriz.multiplicarMatrizesEsparsas(matriz, matriz);
        ...
        for (int tamanho : tamanhos) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                MatrizEstática restultante = matriz.multiplicarMatrizesEsparsas(matriz, matriz);
