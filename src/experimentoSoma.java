public class experimentoSoma {
    public static void experimento(){
        ...
        System.out.println(" ---- >> Calcular Soma de matriz << ---- ");
        System.out.println("---------------------------------------------------");
        ...
        for (int tamanho : tamanhos) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                MListaEncadeada restultante = matriz.somarMatrizesEsparsas(matriz, matriz);
        ...
        for (int tamanho : tamanhos) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                MatrizEstática restultante = matriz.somarMatrizesEsparsas(matriz, matriz);
